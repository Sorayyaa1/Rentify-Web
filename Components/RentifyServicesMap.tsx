            ...
            <div className="w-full grid grid-cols-4 gap-2 ">
               {
                rentifyServicesMapArray.slice(0,-1).map((item,index)=>(
                        ...
                        <div key={index} className="w-full flex flex-col gap-2 items-center justify-center text-center">
                            <div  className="flex items-center justify-center gap-2 relative">
                                ...
                                <hr className=" w-full absolute -left-32 border-[0.1rem] border-[#D7D8DA]"></hr>
                            </div>
